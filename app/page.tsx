...
export default function HomePage() {
  ...
  const ctaButton =
    "inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-lg transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-300";
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 px-4 py-12 sm:py-16">
      <div className="mx-auto flex w-full max-w-6xl flex-col space-y-12 rounded-[28px] border border-white/10 bg-slate-900/70 p-6 shadow-[0_30px_90px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-10">
        <header className="flex flex-col gap-5 text-center">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-indigo-100 shadow-inner shadow-white/10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              href="#calculator"
              className={`${ctaButton} h-12 bg-gradient-to-r from-indigo-500 via-purple-500 to-emerald-400 shadow-indigo-500/40 active:scale-[0.99]`}
            >
              Go to calculator
              <span className="h-5 w-5 rounded-full bg-white/20 backdrop-blur-sm">→</span>
            </a>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr,0.95fr]" id="calculator">
          <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80 p-6 shadow-lg shadow-black/40 backdrop-blur-xl sm:p-8">
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-slate-300">Enter the total home price in your currency. Large numbers automatically format with separators.</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-slate-300">Loan amount updates automatically (price minus down payment).</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/15 bg-slate-900/60 px-4 py-3 text-base text-white shadow-inner shadow-black/60 outline-none transition duration-300 hover:-translate-y-0.5 hover:border-indigo-200/60 hover:shadow-[0_12px_40px_rgba(0,0,0,0.45)] focus:-translate-y-0.5 focus:border-emerald-300/80 focus:ring-4 focus:ring-indigo-500/20"
                  />
                  <p className="text-xs text-slate-300">Annual percentage rate before fees; adjust to test scenarios.</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/15 bg-slate-900/60 px-4 py-3 text-base text-white shadow-inner shadow-black/60 outline-none transition duration-300 hover:-translate-y-0.5 hover:border-indigo-200/60 hover:shadow-[0_12px_40px_rgba(0,0,0,0.45)] focus:-translate-y-0.5 focus:border-emerald-300/80 focus:ring-4 focus:ring-indigo-500/20"
                  />
                  <p className="text-xs text-slate-300">How long you will repay the loan. Typical fixed-rate terms are 15–30 years.</p>
                </div>
              </div>
          ...
          <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900/70 to-indigo-900/80 p-6 shadow-2xl shadow-black/50 sm:p-8">
            <div className="relative space-y-5">
              ...
              <div className="grid gap-3 text-sm text-slate-100">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg shadow-black/40">
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-2 text-slate-200">
                      <span className="h-2.5 w-2.5 rounded-full bg-purple-300" /> Total interest over term
                    </span>
              ...
              <div className="space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4 text-xs leading-relaxed text-amber-100">
                <p className="font-semibold uppercase tracking-[0.2em] text-amber-200">Important</p>
        ...
        <footer className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-slate-900/70 p-6 text-sm text-slate-100 shadow-lg shadow-black/40 sm:flex-row sm:items-center sm:justify-between sm:p-8">
          <div className="space-y-2">
            <h4 className="text-lg font-semibold text-white">World Mortgage Calculator</h4>
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm">
            <a className="rounded-full border border-white/10 bg-white/10 px-3 py-2 transition hover:-translate-y-0.5 hover:border-emerald-200/60 hover:text-white" href="mailto:hello@worldmortgagecalc.com">
              Contact us
            </a>
            <a className="rounded-full border border-white/10 bg-white/10 px-3 py-2 transition hover:-translate-y-0.5 hover:border-emerald-200/60 hover:text-white" href="#privacy">
              Privacy Policy
            </a>
            <a className="rounded-full border border-white/10 bg-white/10 px-3 py-2 transition hover:-translate-y-0.5 hover:border-emerald-200/60 hover:text-white" href="#terms">
              Terms of Service
            </a>
          </div>
        </footer>
