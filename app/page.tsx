...
export default function HomePage() {
  ...
  const ctaButton =
    "inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-lg transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-200";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-sky-50 text-slate-900 px-4 py-12 sm:py-16">
      <div className="mx-auto flex w-full max-w-6xl flex-col space-y-12 rounded-[28px] border border-slate-200 bg-white/90 p-6 shadow-[0_25px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-10">
        <header className="flex flex-col gap-5 text-center">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-slate-200 bg-sky-50 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-sky-700 shadow-inner shadow-sky-100">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              href="#calculator"
              className={`${ctaButton} h-12 bg-gradient-to-r from-sky-500 via-blue-500 to-emerald-400 shadow-sky-400/40 active:scale-[0.99]`}
            >
              Go to calculator
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr,0.95fr]" id="calculator">
          <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/70 backdrop-blur-xl sm:p-8">
            <div className="space-y-5">
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-800" htmlFor="property-price">
                  Property price
                </label>
                <div className="space-y-2">
                  <input
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-800" htmlFor="down-payment">
                  Down payment
                </label>
                <div className="space-y-2">
                  <input
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-800" htmlFor="interest-rate">
                    Interest rate (APR)
                  </label>
                  <input
                    id="interest-rate"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-800" htmlFor="loan-term">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2 text-xs text-slate-600">
                <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-emerald-50 px-3 py-2 shadow-inner shadow-emerald-100/60">
                  <span className="h-2 w-2 rounded-full bg-emerald-400" /> Real-time recalculations
                </span>
                <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-sky-50 px-3 py-2 shadow-inner shadow-sky-100/60">
                  <span className="h-2 w-2 rounded-full bg-sky-400" /> Crisp financial breakdowns
                </span>
              </div>
            </div>
          </section>

          <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-sky-50 via-white to-emerald-50 p-6 shadow-2xl shadow-slate-200/70 sm:p-8">
            <div className="relative space-y-5">
              ...
              <div className="grid gap-3 text-sm text-slate-800">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-lg shadow-slate-200/70">
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-2 text-slate-700">
                      <span className="h-2.5 w-2.5 rounded-full bg-sky-400" /> Total paid over {loanTerm} years
                    </span>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-lg shadow-slate-200/70">
                  <div className="flex items-center justify-between">
                    <span className="flex items-center gap-2 text-slate-700">
                      <span className="h-2.5 w-2.5 rounded-full bg-blue-400" /> Total interest over term
                    </span>
        ...
        <footer className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-6 text-sm text-slate-700 shadow-lg shadow-slate-200/70 sm:flex-row sm:items-center sm:justify-between sm:p-8">
          <div className="space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm">
            <a className="rounded-full border border-slate-200 bg-sky-50 px-3 py-2 text-slate-800 transition hover:-translate-y-0.5 hover:border-sky-300 hover:text-slate-900" href="mailto:hello@worldmortgagecalc.com">
              Contact us
            </a>
            <a className="rounded-full border border-slate-200 bg-sky-50 px-3 py-2 text-slate-800 transition hover:-translate-y-0.5 hover:border-sky-300 hover:text-slate-900" href="#privacy">
              Privacy Policy
            </a>
            <a className="rounded-full border border-slate-200 bg-sky-50 px-3 py-2 text-slate-800 transition hover:-translate-y-0.5 hover:border-sky-300 hover:text-slate-900" href="#terms">
              Terms of Service
            </a>
          </div>
        </footer>
